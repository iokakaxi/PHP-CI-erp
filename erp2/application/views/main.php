    ...
    <div class="main-wrap cf">
      ...
      <ul class="quick-links">
        <li class="purchase-purchase">
        	<a tabid="purchase-purchase" data-right="PU_ADD" tabTxt="购货单" parentOpen="true" rel="pageTab" href="<?php echo site_url('scm/invPu?action=initPur')?>"><img src="../../statics/login/Images/icons_01.png" style="display:block;width:48px;height:48px;margin: 0 auto 20px;"/>采购入库</a>
        </li>
        <li class="sales-sales">
        	<a tabid="sales-sales" data-right="SA_ADD" tabTxt="销货单" parentOpen="true" rel="pageTab" href="<?php echo site_url('scm/invSa?action=initSale')?>"><img src="../../statics/login/Images/icons_02.png" style="display:block;width:48px;height:48px;margin: 0 auto 20px;"/>销货出库</a>
        </li>
        <li class="storage-transfers">
        	<a tabid="storage-transfers" data-right="TF_ADD" tabTxt="调拨单" parentOpen="true" rel="pageTab" href="<?php echo site_url('scm/invTf?action=initTf')?>"><img src="../../statics/login/Images/icons_03.png" style="display:block;width:48px;height:48px;margin: 0 auto 20px;"/>仓库调拨</a>
        </li>
        <li class="storage-inventory">
        	<a tabid="storage-inventory" data-right="PD_GENPD" tabTxt="盘点" parentOpen="true" rel="pageTab" href="<?php echo site_url('storage/inventory')?>"><img src="../../statics/login/Images/icons_04.png" style="display:block;width:48px;height:48px;margin: 0 auto 20px;"/>库存盘点</a>
        </li>
        <li class="storage-otherWarehouse">
        	<a tabid="storage-otherWarehouse" data-right="IO_ADD" tabTxt="其他入库" parentOpen="true" rel="pageTab" href="<?php echo site_url('scm/invOi?action=initOi&type=in')?>"><img src="../../statics/login/Images/icons_05.png" style="display:block;width:48px;height:48px;margin: 0 auto 20px;"/>其他入库</a>
        </li>
        <li class="storage-otherOutbound">
        	<a tabid="storage-otherOutbound" data-right="OO_ADD" tabTxt="其他出库" parentOpen="true" rel="pageTab" href="<?php echo site_url('scm/invOi?action=initOi&type=out')?>"><img src="../../statics/login/Images/icons_06.png" style="display:block;width:48px;height:48px;margin: 0 auto 20px;"/>其他出库</a>
        </li>
        <li class="added-service">
        	<a tabid="setting-addedServiceList" tabTxt="增值服务" parentOpen="true" rel="pageTab" href="<?php echo site_url('settings/addedServiceList')?>"><img src="../../statics/login/Images/icons_07.png" style="display:block;width:48px;height:48px;margin: 0 auto 20px;"/>增值服务</a>
        </li>
        <li class="feedback">
        	<a href="#" id="feedback"><img src="../../statics/login/Images/icons_08.png" style="display:block;width:48px;height:48px;margin: 0 auto 20px;"/>意见反馈</a>
        </li>
      </ul>
    </div>
  </div>
...
<script id="profile" type="text/html">
		<table width="100%" border="0" cellspacing="0" cellpadding="20">
		  <tr>
		    <td><a class="tad t1" tabid="report-initialBalance" data-right="InvBalanceReport_QUERY" tabTxt="商品库存余额" parentOpen="true" rel="pageTab" href="<?php echo site_url('report/goods_balance')?>?search=true" style="overflow:hidden;clear:both;">
			<span>库存总量:<b><#= items[0].total1 #></b></span>
			<!--<span>
				<!--<b style="float:left;">库存总量:</b>
				<!--<b stylr="float:right;"><#= items[0].total1 #></b>
			<!--</span>-->
			<span>库存成本:<b><#= items[0].total2 #></b></span></a></td>
