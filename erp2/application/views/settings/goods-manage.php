        ...
        <div id="manage-wrap" class="manage-wrap">
            <form id="manage-form" action="">
                <ul class="mod-form-rows base-form cf" id="base-form">
                    ...
                    <li class="row-item">
                        <div class="label-wrap"><label for="specs">规格尺码</label></div>
                        <div class="ctn-wrap"><input type="text" value="" class="ui-input" name="specs" id="specs" /></div>
                    </li>
                    <li class="row-item">
                        <div class="label-wrap"><label for="colorType">款号</label></div>
                        <div class="ctn-wrap"><input type="text" value="" class="ui-input" name="colorType" id="colorType" /></div>
                    </li>
                    <li class="row-item">
                    ...
                    <li class="row-item">
                        <div class="label-wrap"><label for="purchasePrice">采购价格</label></div>
                        <div class="ctn-wrap"><input type="text" value="" class="ui-input money" name="purchasePrice" id="purchasePrice" /></div>
                    </li>
                    <li class="row-item">
                        <div class="label-wrap"><label for="unitCost">采购成本</label></div>
                        <div class="ctn-wrap"><input type="text" value="" class="ui-input money" name="unitCost" id="unitCost" /></div>
                    </li>
                    <li class="row-item">
                        <div class="label-wrap"><label for="diaopaiPrice">原价/吊牌价</label></div>
                        <div class="ctn-wrap"><input type="text" value="" class="ui-input money" name="diaopaiPrice" id="diaopaiPrice" /></div>
                    </li>
                    <li class="row-item">
...
<!--                    <li class="row-item"></li>-->
                    <li class="row-item">
                        <div class="label-wrap"><label for="wholesalePrice">批发价1</label></div>
                        <div class="ctn-wrap"><input type="text" value="" class="ui-input money" name="wholesalePrice" id="wholesalePrice"></div>
                    </li>
                    <li class="row-item">
                        <div class="label-wrap"><label for="wholesalePrice2">批发价2</label></div>
                        <div class="ctn-wrap"><input type="text" value="" class="ui-input money" name="wholesalePrice2" id="wholesalePrice2"></div>
                    </li>
                    <li class="row-item">
                        <div class="label-wrap"><label for="wholesalePrice3">批发价3</label></div>
                        <div class="ctn-wrap"><input type="text" value="" class="ui-input money" name="wholesalePrice3" id="wholesalePrice3"></div>
                    </li>
                    <!--<li class="row-item">
                    ...
                    <li class="row-item">
                        <div class="label-wrap"><label for="taobaoPrice">淘宝天猫价</label></div>
                        <div class="ctn-wrap"><input type="text" value="" class="ui-input" name="taobaoPrice" id="taobaoPrice"></div>
                    </li>
                    <li class="row-item" style="width: 229px">
                        <div class="label-wrap" style="width: 72px"><label for="taobaoLink">淘宝天猫链接</label></div>
                        <div class="ctn-wrap"><input type="text" value="" class="ui-input" name="taobaoLink" id="taobaoLink"></div>
                    </li>
                    <li class="row-item">
                        <div class="label-wrap"><label for="jingdongPrice">京东价格</label></div>
                        <div class="ctn-wrap"><input type="text" value="" class="ui-input" name="jingdongPrice" id="jingdongPrice"></div>
                    </li>
                    <li class="row-item">
                        <div class="label-wrap"><label for="jingdongLink">京东链接</label></div>
                        <div class="ctn-wrap"><input type="text" value="" class="ui-input" name="jingdongLink" id="jingdongLink" /></div>
                    </li>
...
<!--    </div>-->
    ...
    <!--<div class="manage-wrapper dn">
        <div id="manage-wrap" class="manage-wrap" style="width: 720px">
            <form id="manage-form" action="">
                <ul class="mod-form-rows base-form cf" id="base-form">
                    <li class="row-item">
                        <div class="label-wrap"><label for="number">淘宝天猫价</label></div>
                        <div class="ctn-wrap"><input type="text" value="" class="ui-input" name="number" id="number"></div>
                    </li>
                    <li class="row-item" style="width: 229px">
                        <div class="label-wrap" style="width: 72px"><label for="name">淘宝天猫链接</label></div>
                        <div class="ctn-wrap"><input type="text" value="" class="ui-input" name="name" id="name"></div>
                    </li>
                    <li class="row-item">
                        <div class="label-wrap"><label for="barCode">京东价格</label></div>
                        <div class="ctn-wrap"><input type="text" value="" class="ui-input" name="barCode" id="barCode"></div>
                    </li>
                    <li class="row-item">
                        <div class="label-wrap"><label for="specs">京东链接</label></div>
                        <div class="ctn-wrap"><input type="text" value="" class="ui-input" name="specs" id="specs" /></div>
                    </li>
                </ul>
            </form>
...
<script src="<?php echo base_url()?>statics/js/dist/goodsManage.js?ver=20155"></script>
