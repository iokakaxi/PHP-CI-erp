var curRow, curCol, loading, SYSTEM = system = parent.SYSTEM,
	...
	THISPAGE = {
		...
		initDom: function(a) {
			...
			var c = '<a id="importAdd" class="ui-btn ui-btn-sp">导入</a><a id="savaAndAdd" class="ui-btn ui-btn-sp">保存并新增</a><a id="save" class="ui-btn">保存</a>',
		...
		addEvent: function() {
			...
			}), $(".wrapper").on("click", "#importAdd", function(b) {
				add_clas1s('上传导入文件','650','400','#export','');
