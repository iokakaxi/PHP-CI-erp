...
function getCustomerData() {
	...
	if (a) {
		var b = {
			...
			wholesalePrice2: Public.currencyToNum($("#wholesalePrice2").val()),
			wholesalePrice3: Public.currencyToNum($("#wholesalePrice3").val()),
            ...
            colorType: $("#colorType").val(),
            unitCost: $("#unitCost").val(),
            diaopaiPrice: $("#diaopaiPrice").val(),
            taobaoPrice: $("#taobaoPrice").val(),
            taobaoLink: $("#taobaoLink").val(),
            jingdongPrice: $("#jingdongPrice").val(),
            jingdongLink: $("#jingdongLink").val(),
...
function initField() {
	$("#note").placeholder(), "edit" == oper ? ($("#number").val(rowData.number), $("#name").val(rowData.name),
		$category.data("defItem", rowData.categoryId), $("#specs").val(rowData.spec), $("#storage").data("defItem", rowData.locationId),
		$("#unit").data("defItem", ["id", rowData.baseUnitId]), void 0 != rowData.purPrice &&
		$("#purchasePrice").val(Public.numToCurrency(rowData.purPrice, pricePlaces)), void 0 != rowData.salePrice &&
		($("#salePrice").val(Public.numToCurrency(rowData.salePrice, pricePlaces)),
		$("#wholesalePrice").val(Public.numToCurrency(rowData.wholesalePrice, pricePlaces)),
		$("#wholesalePrice2").val(Public.numToCurrency(rowData.wholesalePrice2, pricePlaces)),
		$("#wholesalePrice3").val(Public.numToCurrency(rowData.wholesalePrice3, pricePlaces)),
		$("#vipPrice").val(Public.numToCurrency(rowData.vipPrice, pricePlaces)), $("#discountRate1").val(rowData.discountRate1),
		$("#discountRate2").val(rowData.discountRate2)), $("#colorType").val(rowData.colorType),
        $("#taobaoPrice").val(rowData.taobaoPrice),$("#taobaoLink").val(rowData.taobaoLink),
        $("#jingdongPrice").val(rowData.jingdongPrice),$("#jingdongLink").val(rowData.jingdongLink),
		$("#unitCost").val(rowData.unitCost),$("#diaopaiPrice").val(rowData.diaopaiPrice),$("#minInventory").val(rowData.lowQty),
		$("#maxInventory").val(rowData.highQty), rowData.remark && $("#note").val(rowData.remark), $("#barCode").val(rowData.barCode),
		$("#length").val(rowData.length), $("#width").val(rowData.width), $("#height").val(rowData.height),
		$("#weight").val(rowData.weight), rowData.isSerNum && ($isSerNum[0].checked = !0), rowData.isWarranty &&
		($isWarranty[0].checked = !0, $(".isWarrantyIn").show(), $safeDays.val(rowData.safeDays),
		$advanceDay.val(rowData.advanceDay))) : $("#storage").data("defItem", 0),
